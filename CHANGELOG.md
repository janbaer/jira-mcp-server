...
- `parentKey` parameter on `jira-create-issue` to create child issues by specifying a parent issue key

## [1.4.0] - 2026-05-18

### Added

- `jira-search-issues` tool to search for issues using JQL queries
